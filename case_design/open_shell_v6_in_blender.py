...
files = [
    base / "smart_cube_shell_v6_front_load_body.stl",
    base / "smart_cube_shell_v6_front_screen_bezel.stl",
...
bpy.ops.wm.save_as_mainfile(filepath=str(base / "smart_cube_shell_v6_preview.blend"))
