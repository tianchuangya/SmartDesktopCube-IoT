...
def make_front_bezel(mat):
    bezel = box("v17_front_bezel_full_face_outer", (-64, 0, 59), (5, 138, 118), mat)
...
def main():
    clear_scene()
    body_mat = material("v17 body blue gray", (0.10, 0.24, 0.34, 1))
    bezel_mat = material("v17 front bezel black", (0.03, 0.03, 0.035, 1))
    side_mat = material("v17 side slider black", (0.03, 0.03, 0.035, 1))
    cover_mat = material("v17 rear gray", (0.55, 0.55, 0.50, 1))
    lens_mat = material("v17 clear lens preview", (0.55, 0.85, 1.0, 0.35))
    ...
    export_stl(body, "smart_cube_shell_v17_body_screen_entry.stl")
    export_stl(front, "smart_cube_shell_v17_front_bezel_full_face.stl")
    export_stl(side, "smart_cube_shell_v17_side_simple_slider_vents.stl")
    export_stl(back, "smart_cube_shell_v17_back_cover_two_ports_vents.stl")
    export_stl(lens, "smart_cube_shell_v17_top_clear_lens.stl")
    ...
    bpy.ops.wm.save_as_mainfile(filepath=str(BASE / "smart_cube_shell_v17_front_full_bezel_screen_entry_preview.blend"))
